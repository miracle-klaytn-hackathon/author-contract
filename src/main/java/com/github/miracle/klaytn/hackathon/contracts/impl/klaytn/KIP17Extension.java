...
public class KIP17Extension extends KIP17 {

    private final Contract extension;

    // Methods other than KIP7 methods should use extension to invoke
    private KIP17Extension(Caver caver, String address, Contract extension) throws IOException {
        super(caver, address);
        this.extension = extension;
    }

    public static KIP17Extension create(Caver caver, String abi, String address) throws IOException {
        Contract extension = Contract.create(caver, abi, address);
        return new KIP17Extension(caver, address, extension);
    }
    ...
    public String owner() throws IOException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        List<Type> ownerOnChain = this.call("owner");
